...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小达灵灵壹', // 您的昵称 例如 tangly1024
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || '4001400420169509', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
